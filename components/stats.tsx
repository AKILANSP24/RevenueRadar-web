...
const stats = [
  { value: "10K+", label: "Transactions Monitored", color: "#2E86DE" },
  { value: "99.9%", label: "Uptime", color: "#10B981" },
  { value: "<2s", label: "Detection Time", color: "#2E86DE" },
];
    ...
    <section className="relative bg-[#0a0f1e] py-16">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.02] backdrop-blur-sm">
          <div className="absolute inset-0 bg-gradient-to-r from-[#2E86DE]/5 via-[#10B981]/5 to-[#2E86DE]/5" />
          <div className="relative grid divide-y divide-white/5 md:grid-cols-3 md:divide-x md:divide-y-0">
            {stats.map((stat) => (
              <div key={stat.label} className="flex flex-col items-center px-8 py-10 text-center">
                ...
                <span className="mt-2 text-sm text-white/50 sm:text-base">{stat.label}</span>
              </div>
            ))}
          </div>
        </div>
