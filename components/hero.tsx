  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#0a0f1e] pt-32 pb-20">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="animate-blob animation-delay-2000 absolute top-20 right-0 h-[400px] w-[400px] rounded-full bg-[#10B981]/20 blur-[100px]" />
        <div className="animate-blob animation-delay-4000 absolute bottom-0 left-1/2 h-[500px] w-[500px] -translate-x-1/2 rounded-full bg-[#10B981]/25 blur-[120px]" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="text-balance text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
            ...
            <br />
            <span className="bg-gradient-to-r from-[#2E86DE] via-[#10B981] to-[#2E86DE] bg-clip-text text-transparent">
